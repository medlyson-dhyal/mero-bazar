const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-ChMoyXxv.js","assets/Layout-hwjnUqQC.js","assets/ProductCard-CV9nn6j7.js","assets/StarRating-D-MC9IPK.js","assets/chevron-right-AsHmjuWN.js","assets/Categories-tVXlJZd3.js","assets/Search-BgcojYPm.js","assets/Cart-Qa6Kbufj.js","assets/Account-D7EN7HPc.js","assets/package-BO7HxSm8.js","assets/heart-DEvINlHS.js","assets/map-pin-E3hTCx2f.js","assets/ProductDetail-BQdEnW9A.js","assets/CategoryProducts-4wtrsb6L.js","assets/Orders-DagElFjo.js","assets/clock-BsDz4ign.js","assets/OrderDetail-Dos_eYLy.js"])))=>i.map(i=>d[i]);
...
function SkeletonCard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl overflow-hidden animate-pulse", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted aspect-square" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 space-y-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 mt-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-2 bg-muted rounded-sm" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-2 bg-muted rounded-sm" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-2 bg-muted rounded-sm" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-2 bg-muted rounded-sm" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 bg-muted rounded w-1/2 mt-1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 bg-muted rounded-lg mt-2" })
    ] })
  ] });
}
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./Home-ChMoyXxv.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const CategoriesPage = reactExports.lazy(() => __vitePreload(() => import("./Categories-tVXlJZd3.js"), true ? __vite__mapDeps([5,1]) : void 0));
const SearchPage = reactExports.lazy(() => __vitePreload(() => import("./Search-BgcojYPm.js"), true ? __vite__mapDeps([6,1,2,3]) : void 0));
const CartPage = reactExports.lazy(() => __vitePreload(() => import("./Cart-Qa6Kbufj.js"), true ? __vite__mapDeps([7,1,3,4]) : void 0));
const AccountPage = reactExports.lazy(() => __vitePreload(() => import("./Account-D7EN7HPc.js"), true ? __vite__mapDeps([8,1,9,10,11,4]) : void 0));
const ProductDetailPage = reactExports.lazy(() => __vitePreload(() => import("./ProductDetail-BQdEnW9A.js"), true ? __vite__mapDeps([12,1,2,3,10]) : void 0));
const CategoryProductsPage = reactExports.lazy(() => __vitePreload(() => import("./CategoryProducts-4wtrsb6L.js"), true ? __vite__mapDeps([13,1,2,3]) : void 0));
const OrdersPage = reactExports.lazy(() => __vitePreload(() => import("./Orders-DagElFjo.js"), true ? __vite__mapDeps([14,1,15,9,4]) : void 0));
const OrderDetailPage = reactExports.lazy(() => __vitePreload(() => import("./OrderDetail-Dos_eYLy.js"), true ? __vite__mapDeps([16,1,15,9,11]) : void 0));
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 grid grid-cols-2 gap-3", children: [
